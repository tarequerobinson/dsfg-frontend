                ...
                <div className="mt-1">
                  <input
                    ...
                    className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm ${
                      darkMode ? 'bg-zinc-700/50 border-zinc-600 text-zinc-100' : 'bg-white border-gray-300 text-neutral-900'
                    }`}
                  />
                </div>
              </div>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className={`px-2 ${
                    darkMode ? 'bg-zinc-800/30 text-zinc-400' : 'bg-white text-gray-500'
                  }`}>
                    Or continue with
                  </span>
                </div>
              ...
              <div className="mt-6">
                <button
                  ...
                  className={`w-full flex justify-center py-2 px-4 border rounded-md shadow-sm text-sm font-medium ${
                    darkMode ? 'border-zinc-600 text-zinc-200 bg-zinc-700/50 hover:bg-zinc-600/50' : 'border-gray-300 text-gray-700 bg-white hover:bg-gray-50'
              ...
              <div className="mt-6">
                <Link
                  ...
                  className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ${
                    darkMode ? 'text-emerald-400 bg-zinc-700/50 hover:bg-zinc-600/50' : 'text-emerald-600 bg-white hover:bg-gray-50'
                  } transition-colors`}
                >
                  Sign in
                </Link>
